...
let topSkills = `
 <h2>Top Skills</h2>
                    <div class="all-top-skills">
                        ...
                        <div class="js">
                            <img src="https://cdn-icons-png.freepik.com/256/11023/11023876.png?semt=ais_hybrid" alt="">
                        </div>
                    </div>
`;
 ...
 document.getElementById('top-skills').innerHTML = topSkills;
